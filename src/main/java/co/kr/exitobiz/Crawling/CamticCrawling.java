...
public class CamticCrawling implements Crawling {
    ...
    private String url = "http://www.camtic.or.kr/CAMTIC/BBS/BBS_PJTList?PAGE=";
    ...
    public void craw() throws InterruptedException {
        ...
        try {
            ...
            for (int i = page; i > 0; i--) {
                driver.get(url+i);
                List<WebElement> list = driver.findElements(By.xpath("//*[@id=\"main_contents\"]/ul/a"));
                Thread.sleep(1000);
                for (int j = 1; j <= list.size(); j++) {
                    try {
                            WebElement urlXpath = list.get(j-1);
                            WebElement titleXpath = driver.findElement(By.xpath("//*[@id=\"main_contents\"]/ul/a["+j+"]/li/div[2]/div"));
                            ...
                            String bodyUrl = url.replace("&&SearchText=&PAGE="+i,"");
