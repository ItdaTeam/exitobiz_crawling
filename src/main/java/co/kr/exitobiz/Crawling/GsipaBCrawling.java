...
@Component
public class GsipaBCrawling implements Crawling {
    ...
    private String url = "https://mybiz.gsipa.or.kr/gsipa/bbs_list.do?code=sub03b&keyvalue=sub03"; // 유관지원사업
    ...
    public void craw() throws InterruptedException {
        ...
        supportVo.setTitle("강릉과학산업진흥원-유관기관지원사업");
