...
@Component
public class MinistryCrawling implements Crawling {
    ...
    private String url = "https://www.me.go.kr/home/web/board/list.do?maxPageItems=10&maxIndexPages=10&boardMasterId=39&menuId=10524&pagerOffset=";
    private int page = 2; // 게시물이 많지 않아 3 페이지만 크롤링
    ...
    public void craw() throws InterruptedException {
        ...
        supportVo.setTitle("환경부");
        supportVo.setUrl("https://www.me.go.kr");
        ...
        try {
            ...
            for (int i = page; i >= 0; i--) {
                driver.get(url + (i*10));
                List<WebElement> list = driver.findElements(By.xpath("//*[@id=\"content_body\"]/div[2]/table/tbody/tr"));
                Thread.sleep(1000);
                for (int j = 1; j <= list.size(); j++) {
                    try {
                            WebElement titleXpath = driver.findElement(By.xpath("//*[@id=\"content_body\"]/div[2]/table/tbody/tr["+j+"]/td[2]/a"));
