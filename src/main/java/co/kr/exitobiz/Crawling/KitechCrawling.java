...
@Component
public class KitechCrawling implements Crawling {
    ...
    /*
     * 한국생산기술연구원
     * https://www..kitech.re.kr
     *  */

    private String url = "https://www.kitech.re.kr/research/page1-1.php?page=";
    ...
    public void craw() throws InterruptedException {
        ...
        try {
            ...
            for (int i = page; i > 0; i--) {
                driver.get(url + i);
                List<WebElement> list = driver.findElements(By.xpath("//*[@id=\"container\"]/div/div[3]/div[2]/table/tbody/tr"));
                Thread.sleep(1000);
                for (int j = 1; j <= list.size(); j++) {
                    try {
                            WebElement titleXpath = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[2]/table/tbody/tr["+j+"]/td[2]/div[1]/a"));
                            ...
                            String bodyUrl = url.replace("&page="+i,"");
                            vo.setTargetName("한국생산기술연구원");
                            vo.setTargetCatName("-");
                            vo.setLocCode("C82");
                            vo.setSiTitle(title);
