...
@Entity
@Table(name = "crawling_data", schema = "itda_app")
@Getter
@Setter
public class Crawling {
    ...
    public Crawling(String targetName, String targetCatName, String locCode, String siTitle, String mobileUrl, String pcUrl){
