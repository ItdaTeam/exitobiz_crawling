...
public class CrawlingVo {
    ...
    public CrawlingVo(String title, String url, String locCode, String activeYn, String errorYn){
        this.title = title;
        this.url = url;
    ...
    public CrawlingVo(String title, String targetCatName, String locCode, String siTitle, String mobileUrl, String pcUrl){
        this.title = title;
