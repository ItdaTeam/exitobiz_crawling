...
/* .toLocaleString 클래스는 숫자 , 처리해줌 */
document.addEventListener("DOMContentLoaded", function () {
    const tls = document.querySelectorAll(".toLocaleString")
    tls.forEach((el, v) => {
...
document.addEventListener("DOMContentLoaded", function () {
    const numToKor = document.querySelectorAll(".numToKor")
    numToKor.forEach ((el, v) => {
        el.textContent = num2han(el.textContent);
    })
})
